...
recuperareno i dati ed immettono i file da openQA verso os-autoinst per eseguire il file
test. Un sistema host può eseguire più worker. L'applicazione web di openQA 
si occupa della distribuzione dei lavori di test tra i lavoratori. Web
